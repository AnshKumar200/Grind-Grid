...
export default function Navbar() {
    return (
        <div className="flex gap-6 bg-gray-300 w-fit md:px-6 py-2 rounded-2xl items-center max-sm:text-base px-4">
            <Link to="/"><img src="/logo.png" className="object-cover size-8 sm:size-10 md:size-12" /></Link>
